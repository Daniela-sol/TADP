 ...
 * @author Usuario
 */
public class ConsultaRevista extends javax.swing.JFrame {

    /**
     * Creates new form ConsultaLibro
     */
    static DefaultTableModel model = new DefaultTableModel();
    public ConsultaRevista() {
        initComponents();
        ...
        this.jtableRevista.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        jtableRevista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Titulo", "Precio", "No. páginas", "Número", "ISSN"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaRevista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaRevista().setVisible(true);
            }
        });
    }
